...
class JourneyCompleteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final next = journeyId < 3 ? getJourneyTheme(journeyId + 1) : null;
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${journey.name.toUpperCase()} COMPLETE',
                  style: TextStyle(
                    color: journey.accentColor,
                    fontSize: 32,
                    fontWeight: FontWeight.w900,
                    letterSpacing: 4,
                    shadows: [Shadow(color: journey.accentColor.withValues(alpha: 0.5), blurRadius: 20)],
                  ),
                ).animate().fadeIn(delay: 300.ms),
                const SizedBox(height: 12),
                const Text('All 10 levels cleared!',
